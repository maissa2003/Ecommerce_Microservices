...
function readUInt40BE(buf, offset) {
  return (
    (buf.readUInt8(offset) || 0) * SHIFT_LEFT_32 + buf.readUInt32BE(offset + 1)
  );
}
...
function readUInt48BE(buf, offset) {
  return (
    buf.readUInt16BE(offset) * SHIFT_LEFT_32 + buf.readUInt32BE(offset + 2)
  );
}
...
function readUInt56BE(buf, offset) {
  return (
    (((buf.readUInt8(offset) || 0) << 16) | buf.readUInt16BE(offset + 1)) *
      SHIFT_LEFT_32 +
    buf.readUInt32BE(offset + 3)
  );
}
...
function readUInt64BE(buf, offset) {
  return (
    buf.readUInt32BE(offset) * SHIFT_LEFT_32 + buf.readUInt32BE(offset + 4)
  );
}
...
function readUInt40LE(buf, offset) {
  return (
    (buf.readUInt8(offset + 4) || 0) * SHIFT_LEFT_32 + buf.readUInt32LE(offset)
  );
}
...
function readUInt48LE(buf, offset) {
  return (
    buf.readUInt16LE(offset + 4) * SHIFT_LEFT_32 + buf.readUInt32LE(offset)
  );
}
...
function readUInt56LE(buf, offset) {
  return (
    (((buf.readUInt8(offset + 6) || 0) << 16) | buf.readUInt16LE(offset + 4)) *
      SHIFT_LEFT_32 +
...
function readUInt64LE(buf, offset) {
  return (
    buf.readUInt32LE(offset + 4) * SHIFT_LEFT_32 + buf.readUInt32LE(offset)
  );
}
...
function readInt40BE(buf, offset) {
  return (
    (buf.readInt8(offset) || 0) * SHIFT_LEFT_32 + buf.readUInt32BE(offset + 1)
  );
}
...
function readInt56BE(buf, offset) {
  return (
    (((buf.readInt8(offset) || 0) << 16) + buf.readUInt16BE(offset + 1)) *
      SHIFT_LEFT_32 +
    buf.readUInt32BE(offset + 3)
  );
}
...
function readInt40LE(buf, offset) {
  return (
    (buf.readInt8(offset + 4) || 0) * SHIFT_LEFT_32 + buf.readUInt32LE(offset)
  );
}
...
function readInt56LE(buf, offset) {
  return (
    (((buf.readInt8(offset + 6) || 0) << 16) + buf.readUInt16LE(offset + 4)) *
      SHIFT_LEFT_32 +
    buf.readUInt32LE(offset)
  );
}
