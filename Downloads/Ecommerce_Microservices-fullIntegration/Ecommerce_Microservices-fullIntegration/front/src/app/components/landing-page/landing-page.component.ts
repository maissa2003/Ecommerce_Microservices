...
export class LandingPageComponent implements OnInit {
  ...
  // Products now loaded from ArticleService (his addition)
  products: Article[] = [];
  ...
  testimonials = [
    {
      ...
      text:
        "Une expérience d'achat exceptionnelle ! Les produits sont de qualité et le service client est réactif.",
      avatar:
    ...
    },
    {
      ...
      title: 'Entrepreneur',
      text:
        'La livraison est rapide et le suivi de commande impeccable. Je recommande vivement !',
      avatar:
    ...
    },
    {
      ...
      title: 'Designer',
      text:
        'Les produits sont magnifiques et parfaitement emballés. Un vrai plaisir de commander ici.',
      avatar:
