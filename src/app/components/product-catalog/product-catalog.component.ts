  ...
  loadProducts(): void {
    this.products = [
      // Électronique
      {
        ...
        price: 299,
        originalPrice: 399,
        description: 'Montre connectée haut de gamme avec GPS, suivi d\'activité et autonomie de 7 jours.',
      ...
      },
      {
        ...
        price: 499,
        description: 'Tablette 11 pouces avec écran Liquid Retina et processeur M1.',
        category: 'Électronique',
      ...
      },
      {
        ...
        price: 79,
        originalPrice: 99,
        description: 'Enceinte portable étanche avec son 360° et 20h d\'autonomie.',
        category: 'Électronique',
        subcategory: 'Audio',
      ...
      // Mode
      {
        ...
        price: 79,
        description: 'Sac à dos en toile résistante avec compartiment pour ordinateur 15 pouces.',
        category: 'Mode',
      ...
      },
      {
        ...
        price: 199,
        description: 'Montre à quartz avec bracelet en cuir véritable et boîtier en acier inoxydable.',
        category: 'Mode',
        subcategory: 'Montres',
      ...
      // Maison
      {
        ...
        image: 'https://images.unsplash.com/photo-1507473885765-e6c057f00f68?w=400&h=400&fit=crop',
        rating: 4.6,
        reviews: 67,
        stock: 45,
        brand: 'HomeStyle',
      ...
      },
      {
        ...
        category: 'Maison',
        subcategory: 'Textile',
        image: 'https://images.unsplash.com/photo-1584100936591-c0654b55a2e2?w=400&h=400&fit=crop',
        rating: 4.5,
        reviews: 123,
        stock: 67,
        isOnSale: true,
      ...
      },
      {
        ...
        price: 899,
        originalPrice: 999,
        description: 'Smartphone haut de gamme avec appareil photo pro et batterie longue durée.',
        category: 'Électronique',
      ...
      },
      {
        ...
        price: 119,
        description: 'Chaussures de running avec amorti optimal et respirabilité.',
        category: 'Sport',
      ...
      },
      {
        ...
        category: 'Maison',
        subcategory: 'Cuisine',
        image: 'https://images.unsplash.com/photo-1584990347449-6b8dc5a2da11?w=400&h=400&fit=crop',
        rating: 4.6,
        reviews: 234,
        stock: 23,
        isOnSale: true,
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1576995853123-5b10305d93c0?w=400&h=400&fit=crop',
        rating: 4.5,
        reviews: 456,
        stock: 56,
        brand: 'UrbanStyle',
